...
HD_PWD='C:/Users/student/201211/async_single_port_RAM/async_single_port_RAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log async_single_port_RAM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source async_single_port_RAM.tcl -notrace
